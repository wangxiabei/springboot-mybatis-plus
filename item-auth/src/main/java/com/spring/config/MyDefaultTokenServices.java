...
public class MyDefaultTokenServices implements AuthorizationServerTokenServices, ResourceServerTokenServices,
            ...
            if (existingAccessToken.isExpired()) {
                ...
                if(refreshToken != null){
                    ...
                    if (validitySeconds > 0) {
                        refreshToken =  new DefaultExpiringOAuth2RefreshToken(value, new Date(System.currentTimeMillis()
                ...
                if (validitySeconds > 0) {
                    ((DefaultOAuth2AccessToken)existingAccessToken).setExpiration(new Date(System.currentTimeMillis() + (validitySeconds * 1000L)));
                }
    ...
    public OAuth2AccessToken refreshAccessToken(String refreshTokenValue, TokenRequest tokenRequest)
        ...
        if (!supportRefreshToken) {
            throw new InvalidGrantException("登录过期，请重新登录");
        }
